state("x64sc", "Vice 64sc.exe 3.6.1")
{
...
split {
    ...
    if (settings["Debug"]) {
        if (old.currentDeck != current.currentDeck) {
            print(
                "new deck: " + current.currentDeck + "\n" +
                "split: " + vars.numSplits + "\n" +
                "pass: " + current.numPass + "\n" +
                "data: " + current.numData + "\n" +
                "disk: " + current.numDisk
            );
        }
    }
